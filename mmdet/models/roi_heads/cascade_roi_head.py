...
class CascadeRoIHead(BaseRoIHead, BBoxTestMixin, MaskTestMixin):
    ...
    def _bbox_forward(self, stage, x, rois):
        ...
        bbox_feats = bbox_roi_extractor(x[:bbox_roi_extractor.num_inputs],
                                        rois)
        '''
        lh_oris, lw_oris = get_adaptive_scale_rois(rois)
        ori_bbox_feats = bbox_roi_extractor(
            x[:bbox_roi_extractor.num_inputs], rois)
        lh_bbox_feats = bbox_roi_extractor(
            x[:bbox_roi_extractor.num_inputs], lh_oris)
        lw_bbox_feats = bbox_roi_extractor(
            x[:bbox_roi_extractor.num_inputs], lw_oris)
